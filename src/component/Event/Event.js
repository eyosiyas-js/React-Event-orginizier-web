...
import EventHide from "./EventHide";
import EventEdit1 from "./EventEdit/EventEdit1/EventEdit1";
import EventView from "./EventView";
import AddUsher from "./AddUsher";
...
function Event() {
  ...
  const [openAddUsher, setOpenAddUsher] = React.useState(false);
  const [openCreatePromoCode, setOpenCreatePromoCode] = React.useState(false);
  ...
  const handleOpenHide = () => setOpenHide(true);
  const handleCloseHide = () => setOpenHide(false);
  const handleOpenEdit = () => setOpenEdit(true);
  const handleCloseEdit = () => setOpenEdit(false);
  const handleOpenEvent = () => setOpenEvent(true);
  const handleCloseEvent = () => setOpenEvent(false);
  const handleOpenAddUsher = () => setOpenAddUsher(true);
  const handleCloseAddUsher = () => setOpenAddUsher(false);
  const handleOpenCreatePromoCode = () => setOpenCreatePromoCode(true);
  const handleCloseCreatePromoCode = () => setOpenCreatePromoCode(false);
        ...
        >
          ...
          >
            <Grid item sx={{ display: "flex", alignItems: "center" }}>
              {isMatch ? (
                <>
                  <h5 style={{ fontWeight: "bold" }}>New Addis festival</h5>
                </>
              ) : (
                <>
          ...
          >
                ...
                <div>
                  <div className="edit">
                    <MenuItem onClick={handleOpenEdit}>
                      ...
                      <img src={editpImg} className="EditimgIcon" alt="" />
                    </MenuItem>
                  </div>
                  <div className="hide">
                    <MenuItem onClick={handleOpenHide}>
                      <Typography textAlign="center">Hide</Typography>
                      <img src={hideImg} className="HideimgIcon" alt="" />
                    </MenuItem>
                  </div>
                  ...
                  <div className="hide">
                    <MenuItem onClick={handleOpenAddUsher}>
                      <Typography textAlign="center">Add usher</Typography>
                      <img src={AddProfileImg} className="HideimgIcon" alt="" />
                    </MenuItem>
                  </div>
                  <div className="hide">
                  ...
                  <div className="hide">
                    <MenuItem onClick={handleOpenCreatePromoCode}>
                      <Typography textAlign="center">
                        Create promo code
                      </Typography>
                      <img src={editImg} className="HideimgIcon" alt="" />
                    </MenuItem>
                  </div>
                  <div className="hide">
            ...
            <div>
              ...
              >
                <div>
                  <EventHide open={(openHide) => setOpenHide(openHide)} />
                </div>
              </Modal>
            </div>
            <div>
              ...
              >
                <div>
                  <EventEdit1 open={(openEdit) => setOpenEdit(openEdit)} />
                </div>
              </Modal>
            </div>
            <div>
              ...
              >
                <div>
                  <EventView open={(openEvent) => setOpenEvent(openEvent)} />
                </div>
              </Modal>
            </div>
            <div>
              <Modal
                open={openAddUsher}
                onClose={handleCloseAddUsher}
                aria-labelledby="modal-modal-title"
                aria-describedby="modal-modal-description"
              >
                <div>
                  <AddUsher
                    open={(openAddUsher) => setOpenAddUsher(openAddUsher)}
                  />
                </div>
              </Modal>
            </div>
            <div>
              <Modal
                open={openCreatePromoCode}
                onClose={handleCloseCreatePromoCode}
                aria-labelledby="modal-modal-title"
                aria-describedby="modal-modal-description"
              >
                <div>
                  <CreatePromoCode
                    open={(openCreatePromoCode) =>
                      setOpenCreatePromoCode(openCreatePromoCode)
                    }
                  />
                </div>
              </Modal>
