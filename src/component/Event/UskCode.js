...
import uskcodeImg from "../../assets/uskcode.svg";
          ...
          <Box sx={styleM}>
            ...
            >
              <Grid sx={{ width: "100%", height: "90%", display: "flex" }}>
                ...
                >
                  <img style={{ height: "70px" }} src={uskcodeImg} alt=""/>
                </Grid>
                <Grid
                  sx={{
                    width: "75%",
          ...
          <Box sx={style}>
            ...
            >
              <Grid sx={{ width: "100%", height: "90%", display: "flex" }}>
                ...
                >
                  <img style={{ height: "100px" }} src={uskcodeImg} alt="" />
                </Grid>
                <Grid
                  sx={{
                    width: "75%",
